...
function ScrollBar({
  ...
  return (
    <ScrollAreaPrimitive.ScrollAreaScrollbar
      ...
      className={cn(
        "flex touch-none p-px transition-colors select-none bg-border/20",
        orientation === "vertical" &&
    ...
    >
      <ScrollAreaPrimitive.ScrollAreaThumb
        ...
        className="bg-border hover:bg-foreground/50 relative flex-1 rounded-full transition-colors"
      />
    </ScrollAreaPrimitive.ScrollAreaScrollbar>
  )
}
